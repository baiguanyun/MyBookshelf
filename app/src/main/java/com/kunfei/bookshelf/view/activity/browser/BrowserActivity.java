...
import com.kunfei.bookshelf.utils.web.X5WebView;
...
public class BrowserActivity extends AppCompatActivity {
    ...
    private void initBtnListener() {
        LinearLayout llBottomBar = (LinearLayout) findViewById(R.id.llBottomBar);


        mBack = findViewById(R.id.ivBack);
        mForward = findViewById(R.id.ivForward);
        mExit = findViewById(R.id.flWindowsNum);
        mHome = findViewById(R.id.ivHome);
        mGo = (Button) findViewById(R.id.btnGo1);
        mUrl = (EditText) findViewById(R.id.editUrl1);
        mMore = findViewById(R.id.ivMore);
        if (Integer.parseInt(android.os.Build.VERSION.SDK) >= 16) {
            mBack.setAlpha(disable);
            mForward.setAlpha(disable);
            mHome.setAlpha(disable);
