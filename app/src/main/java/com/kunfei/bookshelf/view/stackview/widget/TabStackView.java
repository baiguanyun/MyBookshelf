package com.kunfei.bookshelf.view.stackview.widget;
...
import com.kunfei.bookshelf.view.stackview.SwipeHelper;
...
public class TabStackView extends FrameLayout implements SwipeHelper.Callback {
    ...
    public static final float BASE_MIN_SCROLL_P = 0.53f; // 用于标记参考页最小能滑动的进度
    public static final float PROGRESS_START = 0.78f; // 规定一个定值，用于计算选择页初始进度
    ...
    public TabStackView(@NonNull Context context) {
        this(context, null);
    }

    public TabStackView(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabStackView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//        mLinearOutSlowInInterpolator = AnimationUtils.loadInterpolator(mContext, R.anim.linear_out_show_in);
    ...
    public void animateShow(
        ...
        Log.i("mTabStackView", "selectPager==" + selectPager);
    ...
    private void updateScrollProgressRange() {
        ...
        if (count >= 7) {
            ...
            mMinScrollP = 0.34f - (getChildCount() - 2) * PROGRESS_STEP;
        }
    ...
    private void calculateInitialScrollP() {
        ...
        if (count >= 7) {
            ...
            mScrollProgress = 0.68f - mSelectTab * PROGRESS_STEP;
        }
